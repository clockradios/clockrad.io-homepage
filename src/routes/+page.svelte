...
<body>
  <nav class="bg-white shadow">
    <div class="container mx-auto px-6 py-3">
      <div class="flex items-center justify-between">
        <div>
          <a class="text-gray-800 text-xl font-bold" href="#">clockrad.io</a>
        </div>
        <div class="flex items-center">
          <a class="text-gray-800 hover:text-gray-700 px-3" href="#">Home</a>
          <a class="text-gray-800 hover:text-gray-700 px-3" href="#">Features</a
          >
          <a class="text-gray-800 hover:text-gray-700 px-3" href="#">Contact</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <header class="bg-gray-800 text-white text-center py-16">
    <h1 class="text-4xl font-bold">
      Bridging the Gap Between Users and AI Platforms
    </h1>
    <p class="mt-4 text-gray-400">
      Integrate AI tools into your team's workflow.
    </p>
    <a
      href="#"
      class="mt-6 inline-block bg-blue-500 text-white text-lg py-3 px-6 rounded"
      >Get Started</a
    >
  </header>
  ...
  <footer class="bg-gray-800 text-white py-6">
    <div class="container mx-auto text-center">
      <p class="mb-6">&copy; 2023 clockrad.io. All rights reserved.</p>
      <div class="flex justify-center">
        <a href="#" class="text-gray-400 hover:text-gray-300 mx-3">Terms</a>
        <a href="#" class="text-gray-400 hover:text-gray-300 mx-3">Privacy</a>
        <a href="#" class="text-gray-400 hover:text-gray-300 mx-3">Contact</a>
      </div>
    </div>
  </footer>
</body>
